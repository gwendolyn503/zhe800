...
gulp.task('html',function(){
	gulp.src(['register.html','css/*.css','js/*.js','php/*.php','js/*.js'])//引入的文件路径
	.pipe(connect.reload());//自动刷新的方法
});

gulp.task('watch',function(){//监听
	gulp.watch(['register.html','css/*.css','js/*.js','php/*.php','js/*.js'],['html']);
});
...
//执行的任务
gulp.task('default',['connect','watch','runsass','watchsass']);
